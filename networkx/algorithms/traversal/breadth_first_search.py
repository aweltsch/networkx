    ...
    while queue:
        ...
        try:
            ...
            if child not in visited:
                yield parent, child
                visited.add(child)
                queue.append((child, neighbors(child), depth + 1))
...
def bfs_edges(G, source, reverse=False, depth_limit=None):
    ...
    for e in generic_bfs_edges(G, source, successors, depth_limit=depth_limit):
        yield e
